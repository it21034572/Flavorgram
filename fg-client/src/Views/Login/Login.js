...
export default function Login() {
  ...
  return (
    <div className="custom_container">
      <img className="container__background" src={loginPostData.image} />
      <div className="login_container">
        <div className="login_container__post">
          <div className="login_container__post__details">
            <div className="login_container__post__details__likes">
              <span>
        ...
        <form className="login_container__form">
          ...
          <h1>
            ...
            <span className="gradient"> Craving</span> for more?
          </h1>
          <label>Email</label>
          <input
            type="email"
          ...
          <Link className="link" to={"/register"}>
            Get a foodie account while it's hot
