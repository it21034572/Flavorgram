...
export default function Register() {
  ...
  const registerPostData =
    registerFormCount === 1
      ? {
          image: "./assets/register/form_bg_1.jpg",
          caption: "This one's replacing my favorite cake of all time!",
          likes: "5880",
          comments: "299",
        }
      : {
          image: "https://images.deliveryhero.io/image/fd-sg/LH/vfip-hero.jpg",
          caption: "Sometimes it's never replacable 🤷‍♂️",
          likes: "1203",
          comments: "113",
        };
  ...
  function RegisterForm1() {
    return (
      <form className="login_container__form register">
        ...
        />
        <h1>
          Get your <span className="text__icon">🍨</span>
          <br />
          <span className="gradient">Foodie</span> account here!
        </h1>
        <label id="cpassword">
          Email{" "}
          <span
        ...
        <input
          type="password"
          placeholder="Shhhh ... you know what!"
          value={password}
          onChange={(e) => {
            e.preventDefault();
        ...
        <input
          type="password"
          placeholder="Enter 'You Know What' again ..."
          value={cpassword}
        ...
        >
          {valid ? (
            ...
            <>
              Let's go <FiArrowRight className="button_icon" />
            </>
          )}
        </button>
        ...
        <Link className="link" to={"/login"}>
          Already have an account? Start tasting{" "}
  ...
  function RegisterForm2() {
    return (
      <form className="login_container__form register register1">
        ...
        <label>Pick a good username</label>
        <input
          type="text"
      ...
      <div className="login_container register">
        <div className="login_container__post register">
          <div className="login_container__post__details register">
            <div className="login_container__post__details__likes register">
              <span>
                <IoHeartSharp color="red" />
                {registerPostData.likes}
              </span>

              <span>
                <IoChatbubbleOutline /> {registerPostData.comments}
              </span>
            </div>
            <div className="login_container__post__details__title register">
              {registerPostData.caption}
            </div>
          </div>
